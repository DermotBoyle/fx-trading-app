...
import Auto from "../components/select-automated";

const List = ["AED,	United Arab Emirates Dirham"]["AFN,	Afghan Afghani"][
  "ALL,	Albanian Lek"
  ...
  "BSD,	Bahamian Dollar"
]["BTN,	Bhutanese Ngultrum"]["BWP,	Botswanan Pula"]["BZD,	Belize Dollar"][
  "CAD,	Canadian Dollar"
...
]["MOP,	Macanese Pataca"]["MRO,	Mauritanian Ouguiya (pre-2018)"][
  ...
  "UYU,	Uruguayan Peso"
]["UZS,	Uzbekistan Som"]["VND,	Vietnamese Dong"]["VUV,	Vanuatu Vatu"][
  "WST,	Samoan Tala"
